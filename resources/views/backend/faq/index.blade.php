                        ...
                        <form action="{{ route('admin.faqs.index') }}" method="get">
                            <div class="row justify-content-center g-2">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    @if (request()->query())
                                        <a href="{{ route('admin.faqs.index') }}" class="btn btn-danger">
                                            {{ __('Clear') }}
                                        </a>
                                    @endif
                                </div>
                                    ...
                                    @foreach ($faqs as $key => $data)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <button type="button"
                                                        onclick="editData('{{ route('admin.faqs.edit', $data->id) }}')"
                                                        class="btn btn-info btn-sm">
                                                        <i class="icon-base bx bx-edit-alt me-1"></i>
                                                    </button>
                                                    <button type="button"
                                                        onclick="deleteData('{{ route('admin.faqs.delete', $data->id) }}')"
                            ...
                            <div class="row">
                                <div class="col-md-8 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="question"
                                        value="{{ old('question') }}" placeholder="{{ __('Faq Question') }}" required />
                                    @error('question')
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="answer" class="form-control" cols="30" rows="3" placeholder="{{ __('Answer') }}">{{ old('answer') }}</textarea>
                                    @error('answer')
                                        <span class="text-danger">
                                            {{ $message }}
                                        </span>
